...
#define	LCD_CS_SET  GPIO_SetBits(GPIOG,GPIO_Pin_12)    //片选端口  	     PC9
#define	LCD_RS_SET	GPIO_SetBits(GPIOF,GPIO_Pin_12)    //数据/命令          PC8	   
#define	LCD_WR_SET	GPIO_SetBits(GPIOD,GPIO_Pin_5)    //写数据			 PC7
#define	LCD_RD_SET	GPIO_SetBits(GPIOD,GPIO_Pin_4)    //读数据			 PC6
								    
#define	LCD_CS_CLR  GPIO_ResetBits(GPIOG,GPIO_Pin_12)     //片选端口  	     PC9
#define	LCD_RS_CLR	GPIO_ResetBits(GPIOF,GPIO_Pin_12)     //数据/命令          PC8	   
